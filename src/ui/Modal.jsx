...
function Open({ children, opens: opensWindowName }) {
	const { open } = useContext(ModalContext); // Accessing the context value

	// Passing handler function to the children using: cloneElement(children, {props})
...
// React Portal for modal window using: createPortal(JSX, DOM note (where we want to render this JSX))
